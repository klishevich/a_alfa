...
export type DropdownPopupPropsTargetFieldType = 'anchor' | 'position' | 'screen';
...
export type DropdownPopupPropsFieldType = {
    ...
    directions?: DropdownPopupPropsDirectionsFieldType[];
...
export type DropdownChildrenFieldType = ReactNode[] | ReactNode;
