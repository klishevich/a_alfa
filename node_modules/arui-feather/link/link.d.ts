...
export type LinkIconPositionFieldType = 'left' | 'right';
export type LinkDownloadFieldType = string | boolean;
export type LinkTargetFieldType = '_self' | '_blank' | '_parent' | '_top';
export type LinkSizeFieldType = 'xs' | 's' | 'm' | 'l' | 'xl';
export type LinkChildrenFieldType = ReactNode[] | ReactNode;
...
export interface LinkProps {
     ...
     */
    iconPosition?: LinkIconPositionFieldType;
    /**
     * Текст ссылки
     */
    text?: ReactNode;
     ...
     */
    download?: LinkDownloadFieldType;
    /**
     * target ссылки
     */
